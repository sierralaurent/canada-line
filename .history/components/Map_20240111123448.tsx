...
const Map = () => {
    return (
        <MapContainer 
        style={{height: "100vh"}}
        center={[49.286657673017686, -123.11167716948354]} zoom={14} scrollWheelZoom={true}
        >
            <TileLayer 
                attribution='&copy; <a href="https://github.com/sierralaurent/canada-line.git">By Sierra Laurent</a> contributors'
            ...
            <Marker position={[49.264149140482644, -123.11434122966189]} icon={icon} >
                <Popup>
                    Broadway City Hall
                </Popup>
            </Marker>
            <Marker position={[49.25037530669903, -123.11640621745532]} icon={icon} >
                <Popup>
                    King Edward Station
                </Popup>
            </Marker>
            <Marker position={[49.23471394323408, -123.11653519012727]} icon={icon} >
                <Popup>
                    Oakridge-41st Avenue
                </Popup>
            </Marker>
            <Marker position={[49.22772366750822, -123.11666416279922]} icon={icon} >
                <Popup>
                    Langara-49th Avenue
                </Popup>
            </Marker>
            <Marker position={[49.21820519607773, -123.11743799883097]} icon={icon} >
                <Popup>
                    Marine Drive Station
                </Popup>
            </Marker>
            <Marker position={[49.196667554631865, -123.12618507891636]} icon={icon} >
                <Popup>
                    Bridgeport Station
                </Popup>
            </Marker>
            <Marker position={[49.18411575076447, -123.13636310042726]} icon={icon} >
                <Popup>
                    Aberdeen Station
                </Popup>
            </Marker>
            <Marker position={[49.17554417987126, -123.13608833475666]} icon={icon} >
                <Popup>
                    Lansdowne Station
                </Popup>
            </Marker>
            <Marker position={[49.16825063014887, -123.13637453297012]} icon={icon} >
                <Popup>
            ...
            <Marker position={[49.19681447842791, -123.14624890042657]} icon={icon} >
                <Popup>
                    Templeton Station
                </Popup>
            </Marker>
            <Marker position={[49.19325994809377, -123.157820262565]} icon={icon} >
                <Popup>
                    Sea Island Centre
                </Popup>
            </Marker>
            <Marker position={[49.19445312445108, -123.17825301068314]} icon={icon} >
                <Popup>
                    YVR-Airport Station
                </Popup>
            </Marker>
